...
class EnvSimple2dquant(EnvBase):

    def __init__(self,
                 box_centers,
                 box_sizes,
                 points_per_box=64,
                 name='EnvSimple2dquant',
                 tensor_args=None,
    ...
    def create_object_field(self):
        ...
        return ObjectField(obj_list, 'simple2dquant')
    ...
    def generate_box_points(self,center,size,num_points):
        ...
        # Randomly decide the number of boundary points (between 1/2 and 2/3 of total points)
        boundary_points = torch.randint(num_points // 2, 2 * num_points // 3 + 1, (1,)).item()
