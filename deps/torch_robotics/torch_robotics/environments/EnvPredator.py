...
class EnvPredator(EnvBase):
    ...
    def __init__(self,
        ...
        obj_list = [
            MultiBoxField(
                np.array(
                [[0.5575312972068787, -0.5508843064308167], [0.5575312972068787, 0.5508843064308167],
                 [-0.5575312972068787, 0.5508843064308167], [-0.5575312972068787, -0.5508843064308167],
                 [0.0, -0.5508843064308167],[0.0,0.5508843064308167]
                #  [-0.5575312972068787, 0.0],[0.5575312972068787, 0.0]
                 ]
                ),
                np.array(
                [[0.26, 0.26], [0.26, 0.26],
        ...
        super().__init__(
            ...
            obj_fixed_list=[ObjectField(obj_list, 'Predator')],
